...
define("db_host", default="containers-us-west-38.railway.app", help="blog database host")
define("db_port", default=5511, help="blog database port")
define("db_database", default="railway", help="blog database name")
define("db_user", default="postgres", help="blog database user")
define("db_password", default="Cne0UmgONaeaJaQcqn4p", help="blog database password")
